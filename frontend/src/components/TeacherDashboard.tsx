  ...
  return (
    <div className="flex h-screen bg-secondary/20">
      ...
      <div className="w-64 bg-white border-r border-border card-shadow">
        <div className="p-6">
          <h2 className="text-xl font-bold text-primary" style={{ fontFamily: 'Roboto Mono, monospace' }}>
            Learnify
          </h2>
      ...
      <div className="flex-1 overflow-auto">
        ...
        <div className="bg-white border-b border-border p-4">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-semibold" style={{ fontFamily: 'Roboto Mono, monospace' }}>
              Dashboard
            </h1>
        ...
        <div className="p-6 space-y-6">
          ...
          <Card className="card-shadow border-0">
            <CardHeader>
              <CardTitle style={{ fontFamily: 'Roboto Mono, monospace' }}>Quick Actions</CardTitle>
            </CardHeader>
            <CardContent>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card className="card-shadow border-0">
              <CardHeader>
                <CardTitle style={{ fontFamily: 'Roboto Mono, monospace' }}>Student Engagement</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="h-64">
            ...
            <Card className="card-shadow border-0">
              <CardHeader>
                <CardTitle style={{ fontFamily: 'Roboto Mono, monospace' }}>Recent Learning Paths</CardTitle>
              </CardHeader>
              <CardContent>
