...
const MotivationalQuote = () => {
    ...
    return (
        <div className="flex flex-col justify-center bg-blue-500 p-8 sm:p-12 relative md:rounded-l-none rounded-b-2xl">
            ...
            <p className="text-2xl sm:text-3xl font-bold text-white italic z-10">"{quotes[currentQuote].quote}"</p>
            <p className="text-right mt-4 text-yellow-300 italic text-xl font-semibold z-10">- {quotes[currentQuote].author}</p>
        </div>
    );
};
