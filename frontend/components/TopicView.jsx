...
export default function TopicView({ onNavigate }) {
      ...
      <div className="max-w-7xl mx-auto p-6">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card className="card-shadow border-0">
              <CardHeader>
                <CardTitle className="font-mono">Learning Resources</CardTitle>
              </CardHeader>
              <CardContent>
          ...
          <div className="space-y-6">
            ...
            <Card className="card-shadow border-0">
              <CardHeader>
                <CardTitle className="font-mono">Your Progress</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div>
            ...
            <Card className="card-shadow border-0">
              <CardHeader>
                <CardTitle className="font-mono">Up Next</CardTitle>
              </CardHeader>
              <CardContent>
